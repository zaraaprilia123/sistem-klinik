...
<head>
  ...
  <title>Klinik Cahaya Indah</title>
  <meta
...
<body>
              ...
              <div class="collapse" id="base">
                <ul class="nav nav-collapse">
                  <?php if (session()->get('role') == 'admin') { ?>
                    ...
                    <li>
                      <a href="<?= base_url('customer'); ?>">
                        <span class="sub-item">Pasien/Customer</span>
                      </a>
                    </li>
                  ...
                  <?php if (session()->get('role') == 'kasir') { ?>
                    <li>
                      <a href="<?= base_url('/pendaftaran/kasir'); ?>">
                        <span class="sub-item">Pendaftaran</span>
                      </a>
                    </li>
                  <?php } ?>
  ...
  <!-- jsVectorMap JS (jika kamu menggunakan jsvectormap) -->
  <script src="https://cdn.jsdelivr.net/npm/jsvectormap@4.0.0/dist/js/jsvectormap.min.js"></script>
  ...
  <!-- Sweet Alert -->
  <script src="/template/assets/js/plugin/sweetalert/sweetalert.min.js" scr></script>
  ...
  <script>
    $(document).ready(function() {
      ...
      var action =
        '<td> <div class="form-button-action"> <button type="button" data-bs-toggle="tooltip" title="Edit Task" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"> <i class="fa fa-edit"></i> </button> <button type="button" data-bs-toggle="tooltip" title="Remove" class="btn btn-link btn-danger" data-original-title="Remove"> <i class="fa fa-times"></i> </button> </div> </td>';
      ...
      $("#addRowButton").click(function() {
        ...
        if ($("#add-row").length) {
          $("#add-row")
            .DataTable()
            .row.add(newRow) // Proper way to add data
            .draw();
        }

        // Hide modal after adding row
